...
const AboutBreadcrumb = () => {
  return (
    <section className="about-breadcrumb brand-dark">
      <link
      ...
      <div className="container">
        <div className="inner">
          <div className="title-section">
            <h2 className="title">About AGE Fabrics</h2>
          ...
          <nav className="trail" aria-label="Breadcrumb">
            ...
            <span className="trail-current">About</span>
          </nav>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @media (max-width:768px){
          .about-breadcrumb{ min-height: clamp(200px, 32vh, 320px); }
        }
      `}</style>
    </section>
  );
