              ...
              <div className="tp-trending-banner p-relative ml-35">
                ...
                <div className="tp-trending-banner-content">
                  <h3 className="tp-trending-banner-title">
                    <Link href="/fabric">Short Sleeve Tunic <br /> Tops Casual Swing</Link>
                  </h3>
                  <div className="tp-trending-banner-btn">
                    <Link href="/fabric" className="tp-btn tp-btn-border tp-btn-border-white tp-btn-border-white-sm">
                      Explore More
                      <ArrowRightLong />
                    </Link>
                  </div>
